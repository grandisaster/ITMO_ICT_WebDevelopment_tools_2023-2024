...
from schemas import (IncomeDefault, Income,
                     WasteDefault, WasteShow, Waste,
                     CategoryDefault, CategoryShow, Category,
                     PeriodDefault, PeriodShow, Period,
                     PeriodOfCategoryDefault, PeriodOfCategoryShow, PeriodOfCategory)
...
def category_update(category_id: int, category: CategoryDefault, session=Depends(get_session)) -> Category:
...
def poc_create(poc: PeriodOfCategoryDefault, session=Depends(get_session)) \
        -> TypedDict('Response', {"status": int,
                                  "data": PeriodOfCategory}):
...
def poc_update(poc_id: int, poc: PeriodOfCategoryDefault, session=Depends(get_session)) -> PeriodOfCategory:
...
def period_create(period: PeriodDefault, session=Depends(get_session)) \
        -> TypedDict('Response', {"status": int,
                                  "data": Period}):
...
def period_update(period_id: int, period: PeriodDefault, session=Depends(get_session)) -> Period:
...
def waste_create(input_data: WasteDefault, session=Depends(get_session)) \
        -> TypedDict('Response', {"status": int,
                                  "data": Waste}):
...
def waste_update(waste_id: int, waste: WasteDefault, session=Depends(get_session)) -> Waste:
...
def income_create(income: IncomeDefault, session=Depends(get_session)) \
        -> TypedDict('Response', {"status": int,
                                  "data": Income}):
...
def income_update(income_id: int, income: IncomeDefault, session=Depends(get_session)) -> Income:
